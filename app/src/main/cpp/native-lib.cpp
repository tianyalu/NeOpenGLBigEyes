...
Java_com_sty_ne_opengl_bigeyes_face_FaceTrack_native_1create(JNIEnv *env, jobject thiz,
...
Java_com_sty_ne_opengl_bigeyes_face_FaceTrack_native_1start(JNIEnv *env, jobject thiz, jlong self) {
    if(self == 0) {
        return;
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sty_ne_opengl_bigeyes_face_FaceTrack_native_1stop(JNIEnv *env, jobject thiz, jlong self) {
    if(self == 0) {
        return;
    }
    FaceTrack* faceTrack = reinterpret_cast<FaceTrack *>(self);
